...
public class RedisUtil {
    ...
    public boolean set(final String key, Object value) {
        ...
        try {
            ...
            redisTemplate.expire(key, Constants.TOKEN_TIMEOUT_LONG, TimeUnit.MINUTES);
            result = true;
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public <T> T get(final String key,Class<T> serviceClass) {
        T result = null;
    ...
    public void hmSet(String key, String hashKey, Object value){
        ...
        //redisTemplate.expire(hashKey,TokenConstants.TOKEN_TIMEOUT_LONG,TimeUnit.MINUTES);
     ...
     * @return
     */
    public Object hmRemove(String key, String hashKey){
        HashOperations<String, String, Object>  hash = redisTemplate.opsForHash();
